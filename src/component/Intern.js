    ...
    <div className="student-wrapper">
      ...
      <div className="hero-section">
        ...
        <div className="hero-overlay">
          <h1 className="hero-title">Join Us as an Intern</h1>
        </div>
      </div>
      ...
      <div className="content">
        <p>
          Eager to gain hands-on experience in the world of communication and
          education? Our internship program in Srinagar offers a unique
          opportunity to learn the ropes of a dynamic public speaking academy.
          Support our team, assist with course development, engage with
          students, and hone your own skills. It's the perfect launchpad for a
          career in education or communication.{" "}
          <strong> Discover our internship opportunities! </strong>
        </p>
