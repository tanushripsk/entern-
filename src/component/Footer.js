      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="mt-0 sm:mt-[-60px] md:mt-[-120px]">
            ...
            <p className="text-sm mt-[-40px] sm:mt-[-50px] md:mt-[-70px]">
              {" "}
          ...
          <div className="mt-8 sm:mt-0">
            <h3 className="text-lg font-semibold mb-4 sm:ml-0 md:ml-10">
              Quick Links
            </h3>
            <ul className="space-y-2 sm:ml-0 md:ml-10">
              {[
                ...
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="hover:text-teal-600 text-black transition-colors"
                  >
                    {link.name}
                  </a>
                </li>
          ...
          <div className="mt-8 sm:mt-0">
            ...
            <ul className="space-y-2">
              {[
                { name: "Online Courses", href: "/about" },
                { name: " Tutors", href: "/about" },
          ...
          <div className="mt-8 sm:mt-0">
            ...
            <address className="not-italic">
              <div className="flex items-start mb-2">
                ...
                <span>
                  Kamleshwar , Srinagar Garhwal ,<br />
                  Pauri Uttarakhand, 246174
                </span>
              </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <div className="flex justify-center space-x-4 sm:space-x-6 mb-4">
            ...
            <a
              href="https://www.youtube.com/@Engtern2025"
              className="text-gray-800 hover:text-teal-600"
            >
            ...
            <a
              href="https://in.pinterest.com/engtern2025/_pins/"
              className="text-gray-800 hover:text-teal-600"
            >
